...
<div class='confirm_dialog'>
      ...
      <table class='confirm_table'>
            <tr>
                  <td class='right-align text-deemphasize' title='An example balance'>YOUR ACCOUNT BALANCE</td>
                  <td class='right-align text-emphasize'><?php echo DataFormatter::getInstance()->formatMoney($ledgerRow->ending_balance); ?></td>                               
            </tr>
            <tr>
                  <td class='right-align text-deemphasize' title='Our access fee is $1'>ACCESS FEE</td>
...
<script>
      ...
      function proceed() {
            ...
            var url = '<?php echo Yii::app()->createUrl('demo/createAccess'); ?>';  
